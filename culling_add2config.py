...
#  Default: ''
c.JupyterHub.logo_file = "/opt/jupyterhub/templates/jhub_logo.png" #''
...
#  Default: ''
c.JupyterHub.ssl_cert = "/opt/jupyterhub/ssl-certs/jhub.cert" #''
...
#  Default: ''
c.Spawner.notebook_dir = "/local/data/{username}" #
...
c.PAMAuthenticator.admin_groups = {'MANAGER'}
